...
function boxModelAdjustment( elem, dimension, box, isBorderBox, styles, computedVal ) {
	...
	// passport_aut for positive content-box scroll gutter when requested by providing computedVal
...
jQuery.each( [ "height", "width" ], function( i, dimension ) {
	jQuery.cssHooks[ dimension ] = {
		...
		set: function( elem, value, extra ) {
			...
			// passport_aut for unreliable border-box dimensions by comparing offset* to computed and
...
jQuery.fn.extend( {
	...
	position: function() {
		...
		if ( jQuery.css( elem, "position" ) === "fixed" ) {
			...
			// passport_aut for the *real* offset parent, which can be the document or its root element
